...
I’m interested in Data Engineering, Analytics, and Machine Learning, with a focus on building reliable data workflows and creating insights from real-world datasets.

### I enjoy working on projects involving:

- Data pipelines & workflow automation
- SQL optimization & data transformation
- Analytics dashboards & visualization
- Predictive modeling & machine learning
- Data validation & reproducible workflows

### Currently exploring:

- Cloud & data warehousing concepts
- Analytics engineering workflows
- RAG, LLMs and other AI concepts
...
<!--
**silunij/silunij** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
